...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Image> image = loadImage("/Users/mhudelot/Documents/Synthese/GLImac-Template/TP2/asset/textures/triforce.png");
    if(image == NULL) {
    ...
    auto locateTexture = glGetUniformLocation(program.getGLId(), "uTexture");
